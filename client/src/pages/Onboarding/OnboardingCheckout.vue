...
export default {
	...
	setup () {
		...
		return { userType, plan, stripeChange, paymentOptions, users, goBack, profile, form, onBoard, publishkey, instanceOptions, elementsOptions, cardOptions, card, elms, stripeLoaded, addPayment, isAddButtonVisible, isPurchaseVisible, cardresult, promoInfo, promocode,	applyPromo, savedAmount, discountAmount, isBusiness, seatPrice };
	}
};
</script>
