...
export default {
	...
	setup () {
		...
		return { publishkey, linkaccount, tokenCreated, addPayment, elementRef, payments, makePrimary, customer, instanceOptions, elementsOptions, cardOptions, card, elms, stripeLoaded, isNewMethodVisible, toggleNewMethod, userType, clientBilling, isBusiness };
	}
};
</script>
